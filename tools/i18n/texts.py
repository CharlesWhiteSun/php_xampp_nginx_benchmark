...
TEXTS = {
    "en": {
        ...
        "benchmark_report_intro": "Decision-oriented summary for Laravel deployment selection between XAMPP and NGINX.",
        "report_overview_title": "Key Metrics Overview",
        "report_overall_title": "Overall Deployment Decision",
        "report_overall_item": "Item",
        "report_overall_value": "Result",
        "report_overall_win_throughput": "Throughput Win Count",
        "report_overall_win_latency": "Latency Win Count",
        "report_overall_avg_throughput": "Average Throughput Advantage",
        "report_overall_avg_latency": "Average Latency Advantage",
        "report_overall_final": "Deployment Recommendation",
        "report_view_business": "Business View",
        "report_view_sre": "SRE View",
        "report_confidence_label": "Confidence",
        "report_confidence_basis": "Benchmark Comparison",
        "report_compare_gap": "Winner Gap",
        "report_compare_xampp_score": "XAMPP Score",
        "report_compare_nginx_score": "NGINX Score",
        "report_compare_signal": "Avg Delta Signal",
        "report_confidence_high": "High",
        "report_confidence_medium": "Medium",
        "report_confidence_low": "Low",
        "report_endpoint_title": "Endpoint Differential Analysis",
        "report_action_title": "Differentiated Recommendation Matrix",
        "report_strategy": "Strategy",
        "report_col_scenario": "Laravel Scenario",
        "report_focus": "Focus",
        "report_key_diff": "Key Difference",
        "report_operational": "Operational Impact",
        "report_analysis": "Differential Analysis",
        "report_compare": "Comparative Summary",
        "report_deploy": "Deployment Recommendation",
        "report_reason": "Rationale",
        ...
        "indicators_title": "Section Indicators",
        ...
        "interp_throughput_eval": "Reflects maximum capacity under load. Shows how many requests per second each system can process. Critical for capacity planning.",
        ...
        "interp_latency_eval": "Represents typical user experience. High average latency signals processing delays or contention. Affects perceived responsiveness in interactive applications.",
        ...
        "interp_transfer_eval": "Throughput in KB/sec reflects network/I/O efficiency. Useful for payload-heavy endpoints or when bandwidth is a constraint.",
        ...
        "theme_label": "Theme:",
        "provider_name": "Provided by: Charles",
        "provider_contact": "If you have any requirements, feel free to contact me.",
        "metric_high": "▲ Higher is better",
        "metric_low": "▼ Lower is better",
        "metric_stable": "◆ More stable is better",
    ...
    "zh": {
        ...
        "insights_title": "重點整理",
        "benchmark_report_title": "壓測報告",
        "benchmark_report_intro": "以 Laravel 佈署決策為目標，整合 XAMPP 與 NGINX 的關鍵差異與落地建議。",
        "report_overview_title": "重點指標總覽",
        "report_overall_title": "整體部署決策",
        "report_overall_item": "項目",
        "report_overall_value": "結果",
        "report_overall_win_throughput": "吞吐勝出端點數",
        "report_overall_win_latency": "延遲勝出端點數",
        "report_overall_avg_throughput": "平均吞吐優勢",
        "report_overall_avg_latency": "平均延遲優勢",
        "report_overall_final": "佈署建議",
        "report_view_business": "管理決策版",
        "report_view_sre": "SRE 技術版",
        "report_confidence_label": "信心等級",
        "report_confidence_basis": "壓測評比",
        "report_compare_gap": "勝出差距",
        "report_compare_xampp_score": "XAMPP 分數",
        "report_compare_nginx_score": "NGINX 分數",
        "report_compare_signal": "平均差異訊號",
        "report_confidence_high": "高",
        "report_confidence_medium": "中",
        "report_confidence_low": "低",
        "report_endpoint_title": "端點差異分析",
        "report_action_title": "差異化建議矩陣",
        "report_strategy": "建議策略",
        "report_col_scenario": "Laravel 場景對應",
        "report_focus": "策略焦點",
        "report_key_diff": "關鍵差異",
        "report_operational": "維運影響",
        "report_analysis": "差異化分析",
        "report_compare": "比較摘要",
        "report_deploy": "部署建議",
        "report_reason": "判斷依據",
        ...
        "interp_throughput_eval": "反映負載下的最大容量。顯示每秒能處理的請求數。對容量規劃至關重要。",
        ...
        "interp_latency_eval": "代表典型使用者體驗。延遲高代表處理延遲或資源競爭。影響互動應用的回應速度。",
        ...
        "interp_transfer_eval": "KB/sec 吞吐量反映網路/I/O 效率。對 payload 密集端點或頻寬受限情境尤其有用。",
        ...
        "interp_detail": "詳細分析",
        "theme_label": "佈景主題:",
        "provider_name": "提供者: Charles",
        "provider_contact": "若有任何需求，請不吝與我聯繫",
        "metric_high": "▲ 高值較佳",
        "metric_low": "▼ 低值較佳",
        "metric_stable": "◆ 越穩定越佳",
        "metric_compare": "⇄ 比較指標",
